...
class NotepadUI:
    ...
    def bugPopUp(self):
        ...
        Label(top, text="REPORT A BUG", font=('Mistral 18'), foreground="red", background="#f2fef7").pack(side=tk.TOP, pady=30)

        Label(top, text="Reporting bugs will help us provide a better", font=('Mistral 10'), background="#f2fef7").pack()
        ...
        Label(top, text="--------------------------------------", font=('Mistral 10'), background="#f2fef7").pack(pady=10)
        Label(top, text="Enter your email", font=('Mistral 14'), foreground="#993F0C", background="#f2fef7").pack(side=tk.TOP, pady=5)
        emailfield = tk.Text(top, height=1, width=30, font=('Mistral 12'), borderwidth=0).pack()
        Label(top, text="", font=('Mistral 14'), background="#f2fef7").pack(side=tk.TOP, pady=5)
        Label(top, text="describe the bug", font=('Mistral 14'), foreground="#993F0C", background="#f2fef7").pack(side=tk.TOP, pady=5)
        reportfield = tk.Text(top, height=5, width=30, font=('Mistral 12'), borderwidth=0).pack()

        send = tk.Button(top,command=lambda :self.sendEmail(top,emailfield.get(1.0,tk.END),reportfield.get(1.0,tk.END)),text='Send Report',height=2,width=10, background="#993F0C", foreground="white")
        send.pack(pady=20)
